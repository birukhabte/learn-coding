  ...
  const chapters: Chapter[] = [
    {
      id: 'basics',
      title: 'Python Basics',
      description: 'Syntax, variables, data types, and simple programs',
      totalQuestions: 10,
    },
    {
      id: 'control-flow',
    ...
    },
    {
      id: 'functions',
      title: 'Functions',
      description: 'Function definitions, arguments, and return values',
      totalQuestions: 10,
    },
  ];
      ...
      <header className="border-b-2 border-black bg-white">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-black">Python Programming Quizzes</h1>
            ...
            <Card key={chapter.id} className="border-2 border-black hover:shadow-lg transition-all">
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/quiz/python/${chapter.id}`}>
